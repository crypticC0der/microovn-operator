...
The main branch has ~charmcraft.yaml~ set up to use the base for the next
...
2. Create a commit "Prepare for YY.MM", This should:
   ...
   - Update MICROOVN_TRACK in microovn/src/charm.py to "YY.MM"
   - Update the default risk in charmcraft.yaml to "stable"
