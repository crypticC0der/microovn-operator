...
Alert rules are packaged in [[file:src/prometheus_alert_rules/alerts.yaml][src/prometheus_alert_rules/alerts.yaml]]:
...
Dashboards are packaged in [[file:src/dashboards][src/dashboards/]]:
