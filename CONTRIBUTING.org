* Contributing
** Development Setup
This project uses [[https://python-poetry.org/][Poetry]] for dependency management.
...
- ~INTERFACE_CONSUMER_CHARM_PATH~: Path to a pre-built interface-consumer
  charm (default: auto-detected from [[file:tests/interface-consumer][tests/interface-consumer]])
